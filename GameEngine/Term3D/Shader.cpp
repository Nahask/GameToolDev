...
void Shader::setShaderFragment(std::string shaderFragment)
{
	m_sourceFragment = shaderFragment;
}


void Shader::setShaderVertex(std::string shaderVertex)
{
	m_sourceVertex = shaderVertex;
}
